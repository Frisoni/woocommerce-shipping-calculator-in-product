<div id='shipping-calc'>
	<div id='wscp-form'>
	<input type='tel' id='wscp-postcode' autocomplete="postal-code" placeholder="<?=get_option('wscip_placeholder','Insira o seu CEP')?>" name='wscp-postcode' class='input-text fl-input' />
